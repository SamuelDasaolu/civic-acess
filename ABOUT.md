...
* **⚖️ The "Lazy Judge" System:** We built an automated evaluation pipeline. Every interaction is asynchronously graded by a second AI (Gemini 2.0 Flash) to detect hallucinations and ensure legal accuracy without slowing down the user experience.
